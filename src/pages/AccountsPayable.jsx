...
const AccountsPayable = () => {
    ...
    return (
        <>
            ...
            <PayableDialog open={dialogOpen} onOpenChange={setDialogOpen} onSave={handleSavePayable} payable={editingPayable} accounts={accounts} contacts={contacts} />
...
const PayableDialog = ({ open, onOpenChange, onSave, payable, accounts, contacts }) => {
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="w-[calc(100vw-1rem)] max-h-[92dvh] overflow-y-auto sm:max-w-xl">
                ...
                <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4 pt-2 md:grid-cols-2">
                    ...
                    <div className="space-y-1.5"><Label>Contrapartida (Cuenta de Gasto)</Label><AccountSelector accounts={expenseAccounts} value={data.linkedAccount} onChange={value=>setData({...data,linkedAccount:value})} placeholder="Seleccionar Gasto"/></div>
