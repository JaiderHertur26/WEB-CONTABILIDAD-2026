...
    // 🚀 INDICADOR DE ESTADO VISUAL (Blindado)
    ...
    // 🚀 FUNCIÓN VITAL (Evita que el programa estalle al leer fechas)
    ...
    // 🚀 BLINDAJE ANTI-PANTALLA BLANCA (Garantiza que siempre sea un array)
    const availableYears = React.useMemo(() => {
        const safeTxs = Array.isArray(transactions) ? transactions : [];
        const years = new Set(safeTxs.map(t => getSafeYear(t.date)));
...
    const executeAnnualClosing = () => {
        ...
        // Blindaje estricto de Arrays de lectura
        const safeTxs = Array.isArray(transactions) ? transactions : [];
        const safeIBs = Array.isArray(initialBalance) ? initialBalance : [];
        ...
        // Cargamos saldos iniciales del año a cerrar
...
            date: closingDate,
            description: `ASIENTO DE CIERRE FISCAL ${selectedYear} - CANCELACIÓN CUENTAS RESULTADO`,
