    ...
    const generateReport = () => {
        ...
        allRelevant.forEach(t => {
            ...
            if (t.debitAccount && t.creditAccount) {
                ...
                // EXCLUSIÓN DE TERCEROS (PUENTE) DE LOS TOTALES:
                // Solo sumamos ingresos/egresos si NO son cuentas puente (Terceros = '2')
            ...
            if (accountObj) {
                ...
                // BLINDAJE PARA LAS TARJETAS (ESTADO DE RESULTADOS):
                // Si la categoría contiene nombres clave de terceros/puente y no tiene cuenta,
                // forzamos el prefijo '2' para que NUNCA se sume a los Ingresos/Egresos.
                const catUpper = (t.category || '').toUpperCase();
                if (catUpper.includes('DONA NOBIS') || catUpper.includes('OBOLO') || catUpper.includes('MISIONERA')) {
                    prefix = '2';
                } else {
            ...
            // P&L (Estado de Resultados) - LOS TERCEROS (2) NO ENTRAN AQUÍ
